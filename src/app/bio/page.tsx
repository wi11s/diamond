      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-5 text-sm leading-7 text-black/90">
          <p>
            ...
            filmmaking, and music culture. Their practice is rooted in storytelling through analog processes, driven by a
          ...
          <p>
            Taylor’s photography has been published in Dekopon Magazine, and the short film <em>Rockaway</em> screened at
            the Press Pause Film Festival in Queens, as well as Scores for the Silver Screen Festival in Miami, where it
            received Best Score and 3rd Best Film. They have also collaborated with musicians, fashion brands, and
            artists including Zemeta, Heaven’s Gate, Zambra Jazz Collective, Cash$tarr, BAGH Ka$hKenni, Tomcbumpz,
            Justend, and Lexxie Mathis, bringing a shared sensibility into collaborative projects.
          </p>
          <p>
            As a DJ, Taylor has had the opportunity to perform and collaborate at both local venues and on a national
            stage. In the past, you might have seen Taylor at Pianos, Reforesters Lab, Museum of the Moving Image, Jade
            Bar, Purgatory, Casa Maya, or out on a rooftop. In 2024, Taylor joined the <em>we were so beautiful</em> tour
            with SEB and Justend in Washington D.C., New York City, and Chicago.
          </p>
          <p>
            Creating the work showcased here has been a true treasure for Taylor, and they hope you enjoy experiencing
            it as much as they have loved making it.
          </p>
        </div>
